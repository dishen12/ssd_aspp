...
weight_file=./weights/voc_aspp_b_2_left_last_1259
eval_folder=./eval/voc_aspp_b_2_left_last_1259
for((i=5000;i<=200000;i+=5000));do
    ...
    echo $weight
    echo $save_folder
    python eval_aspp.py --model_type="aspp_b_2_left_last" --trained_model=$weight --save_folder=$save_folder --rate="1,2,5,9"
done
